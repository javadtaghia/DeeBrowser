...
public class DisplayAdapter extends BaseAdapter {
	...
	public DisplayAdapter(Context c) {
		...
		Layout.setCurrentLayout(Layout.fromInt(Integer.parseInt(sharedPref.getString("layout", "5")))); //javad
	...
	private View inflateView (View convertView, Holder mHolder) {
		...
		switch (Layout.getCurrentLayout()) {
			case GRID:
				convertView = layoutInflater.inflate(R.layout.listcell_list_details_small, null); break; // javad convertView = layoutInflater.inflate(R.layout.listcell_grid, null); break;
