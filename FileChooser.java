...
public class FileChooser extends ListActivity {
				...
				if (extras.getStringArrayList("filterFileExtension") != null) {
					...
					fileFilter = new FileFilter() {
						...
						public boolean accept(File pathname) {
							...
							//return ((pathname.isDirectory()) || (pathname.getName().contains(".")?extensions.contains(".txt"):true));
						}
					};
				}
			}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (o.isFolder() || o.isParent()) {
			...
			intent.putExtra("fileSelected", fileSelected.getAbsolutePath());// fileSelected.getAbsolutePath());
