...
public class PreferenceManager {
    ...
    public boolean getAdBlockEnabled() {
        return mPrefs.getBoolean(Name.BLOCK_ADS, true); // javad false to true adblock
    }
    ...
    public boolean getRestoreLostTabsEnabled() {
        return mPrefs.getBoolean(Name.RESTORE_LOST_TABS, false); // javad true to false restore tab
    }
